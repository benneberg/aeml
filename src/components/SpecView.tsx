      ...
      <div className="space-y-3" id="spec-roadmap">
        ...
        <div className="space-y-4 pl-2 border-l-2 border-slate-200" id="spec-timeline">
          ...
          <div className="relative pl-4" id="roadmap-p2">
            ...
            <span className="text-[10px] text-indigo-600 font-mono font-bold uppercase tracking-wider block">Phase 2 - Mobile-first UX (Current)</span>
          ...
          <div className="relative pl-4" id="roadmap-p3">
            <span className="absolute -left-[21px] top-1 h-2 w-2 rounded-full bg-slate-300 border-2 border-white"></span>
            <span className="text-[10px] text-slate-500 font-mono font-bold uppercase tracking-wider block">Phase 3 - Continuous Memory</span>
            <h5 className="text-xs font-bold text-slate-900 mt-0.5">Incident Prediction & Cross-Repository Maps</h5>
            <p className="text-[10px] text-slate-500 leading-relaxed font-sans">
              Linking previous PR history patterns and structural code drift telemetry to estimate regression hazards automatically.
            </p>
          </div>
